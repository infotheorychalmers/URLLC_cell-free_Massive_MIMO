...
%rho_dBm_list = [-20:35]; %transmit power [dB]
rho_dBm_list = [-20:2:20 30 35]; %transmit power [dB]
np = K;
L = 1;
M = 100; %Total number of antennas in the cell-free network (L=4)
%M_list = (6:14).^2; %Total number of antennas in the cell-free network (L=1)
